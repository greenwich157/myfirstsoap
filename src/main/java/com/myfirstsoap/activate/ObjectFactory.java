 ...
 * generated in the com.myfirstsoap.activate package. 
...
public class ObjectFactory {
    ...
    private final static QName _ActivationRequest_QNAME = new QName("http://myfirstsoap.com/activate/", "activationRequest");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.myfirstsoap.activate
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://myfirstsoap.com/activate/", name = "activationRequest")
